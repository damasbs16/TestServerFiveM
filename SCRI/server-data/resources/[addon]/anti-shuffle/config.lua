...
allowKeyShuffle			= true		--	If true, the player can shuffle to their neighboring seat when they press any of the 'exemptKeys' listed below
...
exemptKeys				= {298}		--	[SPACEBAR] (press 'SPACEBAR' to shuffle from passenger to driver seat, or if 'allowKeyShuffle' is 'true', shuffle to your neighboring seat)
