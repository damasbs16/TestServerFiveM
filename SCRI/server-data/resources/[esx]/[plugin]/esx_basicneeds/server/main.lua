...
ESX.RegisterUsableItem('bread', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_bread') })
end)
...
ESX.RegisterUsableItem('chocolate', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_chocolate') })
end)
...
ESX.RegisterUsableItem('sandwich', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_sandwich') })
end)
...
ESX.RegisterUsableItem('hamburger', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'thirst', 70000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_hamburger') })
end)
...
ESX.RegisterUsableItem('cupcake', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_cupcake') })
end)
...
ESX.RegisterUsableItem('chips', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_chips') })
end)
...
ESX.RegisterUsableItem('water', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_water') })
end)
...
ESX.RegisterUsableItem('cocacola', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_cocacola') })
end)
...
ESX.RegisterUsableItem('icetea', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_icetea') })
end)
...
ESX.RegisterUsableItem('coffe', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_coffe') })
end)
...
ESX.RegisterUsableItem('wine', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_wine') })
end)
...
ESX.RegisterUsableItem('beer', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_beer') })
end)
...
ESX.RegisterUsableItem('vodka', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_vodka') })
end)
...
ESX.RegisterUsableItem('whisky', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_whisky') })
end)
...
ESX.RegisterUsableItem('tequila', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_tequila') })
end)
...
ESX.RegisterUsableItem('milk', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_milk') })
end)
...
ESX.RegisterUsableItem('gintonic', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_gintonic') })
end)
...
ESX.RegisterUsableItem('absinthe', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_absinthe') })
end)
...
ESX.RegisterUsableItem('champagne', function(source)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_champagne') })
end)
...
ESX.RegisterUsableItem('cigarett', function(source)
	...
	local lighter = xPlayer.getInventoryItem('lighter')
		...
		if lighter.count > 0 then
			...
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'error', text = ('Anda tidak punya korek') })
		end
end)
