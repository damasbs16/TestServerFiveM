...
AddEventHandler('esx_outlawalert:carJackInProgress', function(targetCoords, streetName, vehicleLabel, playerGender)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', -1, { type = 'inform', text = _U('carjack', playerGender, vehicleLabel, streetName) })
...
AddEventHandler('esx_outlawalert:combatInProgress', function(targetCoords, streetName, playerGender)
	...
	TriggerClientEvent('mythic_notify:client:SendAlert', -1, { type = 'inform', text = _U('combat', playerGender, streetName) })
