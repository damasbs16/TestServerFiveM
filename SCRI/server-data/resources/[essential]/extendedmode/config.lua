...
Config.FirstSpawnCoords = {x = -726.0, y = -1302.4, z = 5.1, heading = 15.1} -- first spawn coordinates
...
Config.MaxWeight            = 75000   -- the max inventory weight without backpack(this is in grams, not kg!)
